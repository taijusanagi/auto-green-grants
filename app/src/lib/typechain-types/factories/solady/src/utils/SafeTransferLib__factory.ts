...
import type { SafeTransferLib, SafeTransferLibInterface } from "../../../../solady/src/utils/SafeTransferLib";
...
const isSuperArgs = (xs: SafeTransferLibConstructorParams): xs is ConstructorParameters<typeof ContractFactory> =>
  xs.length > 1;
...
export class SafeTransferLib__factory extends ContractFactory {
  ...
  override deploy(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<SafeTransferLib> {

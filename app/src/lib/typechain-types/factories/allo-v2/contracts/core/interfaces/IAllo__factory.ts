...
import type { IAllo, IAlloInterface } from "../../../../../allo-v2/contracts/core/interfaces/IAllo";
...
export class IAllo__factory {
  ...
  static createInterface(): IAlloInterface {
    return new utils.Interface(_abi) as IAlloInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): IAllo {
    return new Contract(address, _abi, signerOrProvider) as IAllo;
  }
}
